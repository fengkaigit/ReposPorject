...
public class QueryBillBO implements java.io.Serializable {
	...
	public QueryBillBO(Double money, Integer payType, Integer payStatus,
	...
	public QueryBillBO(Integer payType, Integer payStatus,
