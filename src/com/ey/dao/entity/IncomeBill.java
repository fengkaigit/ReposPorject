...
/**
 * IncomeBill entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "income_bill")
public class IncomeBill implements java.io.Serializable {
	...
	/** minimal constructor */
	public IncomeBill(Long id, Date createDate, Double profitMoney, Integer status) {
		this.id = id;
