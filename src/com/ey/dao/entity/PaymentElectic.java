...
/**
 * PaymentElectic entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "payment_electic")
public class PaymentElectic implements java.io.Serializable {
	...
	/** default constructor */
	public PaymentElectic() {
	}

	/** minimal constructor */
	public PaymentElectic(Long id, Long userId, Date beginPeriod,
	...
	/** full constructor */
	public PaymentElectic(Long id, Long userId, Long modelId, Date beginPeriod,
