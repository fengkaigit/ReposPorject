...
/**
 * PaymentCatv entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "payment_catv")
public class PaymentCatv implements java.io.Serializable {
	...
	/** minimal constructor */
	public PaymentCatv(Long id, Long userId, Date beginPeriod,
	...
	/** full constructor */
	public PaymentCatv(Long id, Long userId, Long modelId, Date beginPeriod,
