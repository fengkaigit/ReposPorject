...
/**
 * PersonTransferRelationId entity. @author MyEclipse Persistence Tools
 */
@Embeddable
public class PersonTransferRelationId implements java.io.Serializable {
	...
	/** default constructor */
	public PersonTransferRelationId() {
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof PersonTransferRelationId))
			return false;
		PersonTransferRelationId castOther = (PersonTransferRelationId) other;
