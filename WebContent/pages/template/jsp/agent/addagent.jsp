...
$(document).ready(function(){
	...
	$("#cardNumber").formValidator({onShow:"请输入银行账号",onFocus:"银行账号至少16个字符",onCorrect:"输入合法"}).inputValidator({min:16,empty:{leftEmpty:false,rightEmpty:false,emptyError:"账号两边不能有空符号"},onError:"银行账号非法,请确认"});//regexValidator({ regExp: "num", dataType: "enum", onError: "只能输入数字" });
