	...
	if(gloabObj.total!=0){
	   $("#pageNav").pagination({
	        ...
	        onPageClick:function(pageNumber, event){
			    window.location.href = "<%=request.getContextPath() %>/agent/worklist.do?status=1&page="+pageNumber+"&rows="+gloabObj.rows;
			}
	  });
	}
});
...
<div class="jfzh-con">
	...
	<div class="name"><span class="fl"><img src="<%=request.getContextPath() %>/images/common/icon2.png" width="16">&nbsp;&nbsp;已办任务</span>
	</div>
