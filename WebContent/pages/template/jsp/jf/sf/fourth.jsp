...
<div class="ui-box   appcenter-list">
  ...
  <div class="mtb10 clearfix" style="width:100%;">
     ...
     <div class="jfxx_btns" style="float:right;padding-right:30px; display:inline-block; height:30px;"><input  type="button"class="jfxx_btn3" value="下载到本地" name="searchBill" onclick="expWord(0,${WATER_BILL.billId},'<%=request.getContextPath() %>');"></div>
  </div>
  ...
  <td>流水号：${WATER_BILL.billId}
  </td>
  </tr>
  </table>
   <div class="div1">
   本次：水费&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;账单总金额：${WATER_BILL.totalMoney}元
   </div>
...
<table width="90%" border="0" cellspacing="0" cellpadding="0" class="tab-style tab2">
   <tr bgcolor="#e6edfb">
    <td colspan="6">&nbsp;支付信息（累计支付1张账单，支付总金额：${WATER_BILL.totalMoney}元）</td>
  </tr>
   <tr >
    <td>&nbsp;支付机构</td>
