...
<div class="ui-box   appcenter-list">
   ...
   <ul >
    ...
    <li><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;金额：</span>${YXDSF_BILL.totalMoney}元（包含代缴服务费${YXDSF_BILL.poundage}元）</li>
  ...
  <td>流水号：${YXDSF_BILL.billId}
   ...
   <div class="div1">
   本次：有线电视费&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;账单总金额：${YXDSF_BILL.totalMoney}元
   </div>
...
<table width="90%" border="0" cellspacing="0" cellpadding="0" class="tab-style tab2">
   <tr bgcolor="#e6edfb">
    <td colspan="6">&nbsp;支付信息（累计支付1张账单，支付总金额：${YXDSF_BILL.totalMoney}元）</td>
  </tr>
   <tr >
    <td>&nbsp;支付机构</td>
