...
<div class="ui-box   appcenter-list">
    ...
    <div coor="default-content" class=" ui-grid-20  ui-grid-right">
      <div style="overflow: hidden;" class="znx_r">
        ...
        <div class="clear"></div>
        <div style="margin-bottom: 0px; display: block; float: left;" id="icon_title_0000"><div style="float:left">燃气缴费<span class="icon_futitle">单笔账单快速支付</span></div>
          <span style="float:right; margin-top:15px; margin-right:40px;" class="lcyst03">
		  <a class="ywjs" target="_blank" onClick="show('addbills')">燃气缴费设置</a>
      ...
      <div class="tx_step">
        ...
        <div class="jf_txxx">
        	...
        	<div class="jf_txxx_left">
            	...
            	<form  method="post" id="form1" action="<%=request.getContextPath() %>/rqf/second.do">
					...
					<div style="padding:0px 0px 10px 0px;">
						<label>公用事业单位：</label>
		                <select class="selectCss" default="" onchange="jQuery.shfftBillCharge.billOrgChange(this,'queryBillChargeMode')" id="billOrg" name="billOrgSel" onmousewheel="return false"><option id="888883200942900" value="888883200942900" statuscode="00" statusname="" limit="" paymentcart="0">呼和浩特市燃气公司</option></select>
					</div>
...
<div class="jfxx_btns"><input  type="submit" class="jfxx_btn3"  value="下一步" name="searchBill"></div>
  ...
  <p>  &nbsp;1、因暂未开通与燃气公司的系统对接，故暂采取人工跑腿代缴方式完成亲的缴费，故在正常水费基础上增加1元代缴者的劳务费，请亲谅解！</p>
