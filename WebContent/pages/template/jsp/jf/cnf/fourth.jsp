...
<div class="ui-box   appcenter-list">
   ...
   <ul >
    ...
    <li><span>订单日期：</span>${CNF_BILL.billDate}</li>
  ...
  <td>流水号：${CNF_BILL.billId}
   ...
   <div class="div1">
   本次：供热费&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;账单总金额：${CNF_BILL.billMoney+CNF_BILL.poundage}元
   </div>
  ...
  <tr>
    <td width="15%">&nbsp;分户账号</td>
    <td width="30%">&nbsp;${CNF_BILL.billNumber}</td>
    <td width="15%">&nbsp;缴费地址</td>
    <td width="30%">&nbsp;${CNF_BILL.payAddress}</td>
  </tr>
  <tr>
    <td>&nbsp;账期</td>
    <td>&nbsp;${CNF_BILL.year}年${CNF_BILL.month}月</td>
    <td>&nbsp;金额</td>
    <td>&nbsp;${CNF_BILL.billMoney}元</td>
  </tr>
 <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;代缴服务费</td>
    <td>&nbsp;${CNF_BILL.poundage}元</td>
  </tr>
</table>
<table width="90%" border="0" cellspacing="0" cellpadding="0" class="tab3 tab-style" style="border-top:0px;">
   <tr bgcolor="#e6edfb">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;合计：</td>
    <td>&nbsp;${CNF_BILL.billMoney+CNF_BILL.poundage}元</td>
  </tr>
  <tr>
    <td>&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;大写金额：</td>
    <td>&nbsp;${CNF_BILL.moneycn}</td>
  </tr>
</table>

<table width="90%" border="0" cellspacing="0" cellpadding="0" class="tab-style tab2">
   <tr bgcolor="#e6edfb">
    <td colspan="6">&nbsp;支付信息（累计支付1张账单，支付总金额：${CNF_BILL.billMoney+CNF_BILL.poundage}元）</td>
  </tr>
   <tr >
    <td>&nbsp;支付机构</td>
    <td>&nbsp;${CNF_BILL.bankName}</td>
    <td>&nbsp;卡号/账号</td>
    <td>&nbsp;${CNF_BILL.bankAccount}</td>
    <td>&nbsp;支付金额</td>
    <td>&nbsp;${CNF_BILL.billMoney+CNF_BILL.poundage}元</td>
  </tr>
</table>
