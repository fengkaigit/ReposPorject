    ...
    <div coor="default-content" class=" ui-grid-20  ui-grid-right">
      <div style="overflow: hidden;" class="znx_r">
        ...
        <div style="margin-bottom: 0px; display: block; float: left;" id="icon_title_0000"><div style="float:left">固话缴费<span class="icon_futitle">单笔账单快速支付</span></div>
		  ...
		  <a class="ywjs" onClick="quickSetting('<%=request.getContextPath() %>',3)">固话缴费设置</a>
...
<input  type="submit" class="jfxx_btn3"  value="下一步" name="searchBill"></div>
  ...
  <p>  &nbsp;1、因暂未开通与电信公司的系统对接，故暂采取人工跑腿代缴方式完成亲的缴费，故在正常固话、宽带费基础上增加${poundage}元代缴者的劳务费，请亲谅解！</p>
  <p>  &nbsp;2、有需要发票的亲，可自行到电信公司网点柜台打印，或留下地址邮寄给您，但邮寄费需要您来承担。</p></span>
