...
<div class="ui-box   appcenter-list">
      ...
      <div style="overflow: hidden;" class="znx_r clear">
    	<div class="tcxx_tt">
        	...
        	<!--<span class="tcxx_tt_a">
        	 <a href="/shanghai/shuifei">固话宽带费</a>
    ...
    <li><span>订单日期：</span>${GHF_BILL.billDate}</li>
  ...
  <div class="mtb10 clearfix" style="width:100%;">
     ...
     <div class="jfxx_btns" style="float:right;padding-right:30px; display:inline-block; height:30px;"><input  type="button" class="jfxx_btn3" value="下载到本地" name="searchBill" onclick="expWord(3,${GHF_BILL.billId},'<%=request.getContextPath() %>');"></div>
  </div>
  <div class="zfcg clear" id="zfpz" style="display:none;">
  <table class="tab1"  cellpadding="0" cellspacing="0">
  <tr>
  <td>订单号：${GHF_BILL.billNo}
  </td>
  <td>流水号：${GHF_BILL.billId}
  </td>
  </tr>
  </table>
   <div class="div1">
   本次：固话宽带费&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;账单总金额：${GHF_BILL.billMoney+GHF_BILL.poundage}元
   </div>
  ...
  <tr>
    <td width="15%">&nbsp;分户账号</td>
    <td width="30%">&nbsp;${GHF_BILL.billNumber}</td>
    <td width="15%">&nbsp;缴费地址</td>
    <td width="30%">&nbsp;${GHF_BILL.payAddress}</td>
  </tr>
  <tr>
    <td>&nbsp;账期</td>
    <td>&nbsp;${GHF_BILL.year}年${GHF_BILL.month}月</td>
    <td>&nbsp;金额</td>
    <td>&nbsp;${GHF_BILL.billMoney}元</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;代缴服务费</td>
    <td>&nbsp;${GHF_BILL.poundage}元</td>
  </tr>
</table>
<table width="90%" border="0" cellspacing="0" cellpadding="0" class="tab3 tab-style" style="border-top:0px;">
   <tr bgcolor="#e6edfb">
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;合计：</td>
    <td>&nbsp;${GHF_BILL.billMoney+GHF_BILL.poundage}元</td>
  </tr>
  <tr>
    <td>&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;大写金额：</td>
    <td>&nbsp;${GHF_BILL.moneycn}</td>
  </tr>
</table>

<table width="90%" border="0" cellspacing="0" cellpadding="0" class="tab-style tab2">
   <tr bgcolor="#e6edfb">
    <td colspan="6">&nbsp;支付信息（累计支付1张账单，支付总金额：${GHF_BILL.billMoney+GHF_BILL.poundage}元）</td>
  </tr>
   <tr >
    <td>&nbsp;支付机构</td>
    <td>&nbsp;${GHF_BILL.bankName}</td>
    <td>&nbsp;卡号/账号</td>
    <td>&nbsp;${GHF_BILL.bankAccount}</td>
    <td>&nbsp;支付金额</td>
    <td>&nbsp;${GHF_BILL.billMoney+GHF_BILL.poundage}元</td>
  </tr>
</table>
