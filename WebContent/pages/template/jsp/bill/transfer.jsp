...
<div class="jfzh-con">
	...
	<div class="name"><span class="fl"><img src="<%=request.getContextPath() %>/images/common/icon2.png" width="16">&nbsp;&nbsp;转账记录</span>
	</div>
  ...
  <c:forEach var="item" items="${settlelist}" varStatus="status">
   <tr <c:choose>
    ...
    <td>&nbsp;<a title="查看对应劳务费划款单" class="cur" style="color:#007abd;"  onClick="openWin('<%=request.getContextPath() %>/bill/showServiceSettle/${item.id}.do')">${item.id}</a></td>
