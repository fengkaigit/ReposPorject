        ...
        <div class="userbar">
			...
			<li><span><a href="<%=request.getContextPath() %>/bill/servicelist.do">单据查询</a></span>
				<ul>
					...
					<li class="current"><a href="<%=request.getContextPath() %>/bill/steriliselist.do">冲销金额划款单查询</a></li>
					<li class="current"><a href="<%=request.getContextPath() %>/bill/incomelist.do">最终盈利划款单查询</a></li>
					<li class="current"><a href="<%=request.getContextPath() %>/bill/transferlist.do">代理商月终清算查询</a></li>
					<li class="current"><a href="<%=request.getContextPath() %>/bill/transferlist.do">系统月终清算查询</a></li>
			  </ul></li>
