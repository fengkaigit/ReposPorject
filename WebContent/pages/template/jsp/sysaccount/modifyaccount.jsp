...
<div>
<div class="jf_main">
<form method="post" action="<%=request.getContextPath() %>/sysaccount/save.do?id=${agent.id}&accId=${bankAcc.id}" id="agentForm" onsubmit="return initArea()">
    <div class="zc_zone">
        <div class="zc_title">
            <div class="card_title1">
                <ul>
                <li style="float:left;"><span>修改系统账户</span></li> 
                 </ul>
