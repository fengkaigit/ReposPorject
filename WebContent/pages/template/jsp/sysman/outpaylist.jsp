...
function showReplyDiv(batchId,id,flag){
	jQuery.shfftAjaxHandler.ajaxRequest("<%=request.getContextPath() %>/sysman/showErrNotice.do",{batchId:batchId,billId:id,doflag:flag},"get","json",function(data){
		   if(data!=null&&data!=''){
