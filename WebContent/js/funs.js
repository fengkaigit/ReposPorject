...
function addsj(num,id){
	if(num==1000){
		var str='<div style="margin-top:10px;clear:both;" id="tab_'+num+'"><table cellpadding="0" cellspacing="0" width="100%"><tr><td>'
		   ...
		   +'<input type="text" value="" style="width:140px;" onBlur="checktel(\'telnum_'+num+'\')" class="on-show" id="telnum_'+num+'" name="billSubmitVo.billNo" maxlength="11"></td>'
 			+'<td><span style=" margin-right:8px;" >充值金额：</span> </td><td>'
			+'<select style="width:65px;margin-top:0px;" class="selectCss" onChange="jQuery.shfftBillCharge.billCityChange()" id="billCity">'
              +'<option   value="08" statuscode="00" statusname="" limit="" paymentcart="">30</option>'
               +'<option value="09" statuscode="00" statusname="" limit="" paymentcart="">50</option>'
               +'<option   value="10" statuscode="00" statusname="" limit="" paymentcart="">100</option>'
              +'<option   value="11" statuscode="00" statusname="" limit="" paymentcart="">200</option>'
                +'<option  value="12" statuscode="00" statusname="" limit="" paymentcart="">500</option></select>'
	...
	var str='<div style="margin-top:10px;clear:both;" id="tab_'+tabId+'"><table cellpadding="0" cellspacing="0" width="100%"><tr><td>'
			+'<label class="label">手机号码：</label></td><td>'
		   +'<input type="text" value="" style="width:140px;" onBlur="checktel(\'telnum_'+tabId+'\')" class="on-show" id="telnum_'+tabId+'" name="billSubmitVo.billNo" maxlength="11"></td>'
 			+'<td><span style=" margin-right:8px;" >充值金额：</span> </td><td>'
			+'<select style="width:65px;margin-top:0px;" class="selectCss" onChange="jQuery.shfftBillCharge.billCityChange()" id="billCity">'
              +'<option   value="08" statuscode="00" statusname="" limit="" paymentcart="">30</option>'
               +'<option value="09" statuscode="00" statusname="" limit="" paymentcart="">50</option>'
